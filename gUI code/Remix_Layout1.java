...
public class Remix_Layout1 implements WindowListener{
    ...
    public void show(){
      ...
      //  panel[2].setLayout(new BoxLayout(panel[2],BoxLayout.X_AXIS));  // setting the orientation of layout
        ...
        panel[3].add(button[3][0]);  // setting button in panel number 4
    ...
    public static void main(String[] args){
        Remix_Layout1 obj = new Remix_Layout1();
        obj.show();
    }
